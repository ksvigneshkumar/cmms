...
import { Mail, Loader2, AlertCircle, Layers, ArrowLeft, CheckCircle2 } from 'lucide-react';
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 relative">
        ...
        <div className="w-full max-w-sm space-y-10 relative z-10">
          ...
          <form className="space-y-6" onSubmit={handleReset}>
            ...
            {message && (
              <div className="p-4 rounded-xl bg-green-500/10 border border-green-500/20 flex items-start gap-3 text-green-600 text-sm animate-in fade-in slide-in-from-top-2">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl text-sm font-semibold text-primary-foreground bg-primary hover:bg-primary/90 focus:outline-none focus:ring-4 focus:ring-primary/20 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
            >
